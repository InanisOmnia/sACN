...
export declare class Sender extends EventEmitter {
    ...
    readonly perAddressPriority: Sender.Props["perAddressPriority"];
    private readonly defaultPacketOptions;
    private sequence;
    resendStatus: boolean;
    constructor({ universe, port, reuseAddr, minRefreshRate, defaultPacketOptions, iface, useUnicastDestination, perAddressPriority }: Sender.Props);
