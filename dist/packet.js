...
class Packet {
    constructor(input, sourceAddress) {
        ...
        this.startCode = 0; // 0x00 for DMX Data and 0xdd for Per Address Priority Data
    ...
    get payload() {
        return this.privatePayload instanceof Buffer ? (0, util_1.objectify)(this.privatePayload) : this.privatePayload;
    }
    get payloadAsBuffer() {
    ...
    get buffer() {
        ...
        (0, util_1.empty)(512) // 126-638 = dmx channels 1-512
        );
