...
import { ACN_PID, DEFAULT_CID, DmpVector, FrameVector, RootVector } from "./constants";
...
export class Packet {
	...
	public startCode = 0; // 0x00 for DMX Data and 0xdd for Per Address Priority Data
	...
	public constructor(
		...
		if (input instanceof Buffer) {
			...
			this.priority = options.priority == undefined || options.priority == null ? 100 : options.priority;
	...
	public get payload(): Payload {
		return this.privatePayload instanceof Buffer ? objectify(this.privatePayload) : this.privatePayload;
	}
